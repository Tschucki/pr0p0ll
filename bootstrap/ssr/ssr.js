import { mergeProps, useSSRContext, withCtx, unref, createVNode, createTextVNode, openBlock, createBlock, createCommentVNode, resolveDirective, toDisplayString, resolveComponent, createSSRApp, h } from "vue";
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "relative mx-auto max-w-7xl px-6 lg:px-8" }, _attrs))}><div class="mx-auto max-w-2xl lg:max-w-none">`);
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<button${ssrRenderAttrs(mergeProps({ class: "inline-flex rounded-lg bg-pr0gramm-500 px-4 py-1.5 text-sm font-semibold text-white transition hover:bg-pr0gramm-500/80" }, _attrs))}>`);
  ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
  _push(`</button>`);
}
...
const _sfc_main$4 = /* @__PURE__ */ Object.assign({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _directive_motion = resolveDirective("motion");
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "mx-auto mt-24 max-w-7xl px-6 sm:mt-32 md:mt-56 lg:px-8" }, _attrs))}><div class="mx-auto max-w-2xl lg:max-w-none"><div${ssrRenderAttrs(mergeProps({
        class: "max-w-3xl",
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  }, ssrGetDirectiveProps(_ctx, _directive_motion)))}><div class="pointer-events-none font-medium text-[#f2f5f4]">`);
  ssrRenderSlot(_ctx.$slots, "image", {}, null, _push, _parent);
  _push(`</div><h2 class="font-display pointer-events-none mt-6 text-2xl font-semibold text-[#f2f5f4]">`);
  ssrRenderSlot(_ctx.$slots, "feature", {}, null, _push, _parent);
  _push(`</h2><p class="pointer-events-none mt-4 text-base text-[#f2f5f4]/80">`);
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _directive_motion = resolveDirective("motion");
  _push(`<!--[--><div class="mx-auto mt-24 max-w-7xl px-6 sm:mt-32 md:mt-56 lg:px-8"><div class="mx-auto max-w-2xl lg:max-w-none"><div${ssrRenderAttrs(mergeProps({
    class: "max-w-3xl",
    initial: { opacity: 0, y: 100 },
    enter: { opacity: 1, y: 0, scale: 1 },
    delay: 150
    ...
    enter: { opacity: 1, y: 0, scale: 1 },
    delay: 300
  }, ssrGetDirectiveProps(_ctx, _directive_motion)))}><div class="relative flex flex-col-reverse pl-8 before:absolute before:left-0 before:top-0 before:h-6 before:w-px before:bg-[#f2f5f4] after:absolute after:bottom-0 after:left-0 after:top-8 after:w-px after:bg-[#f2f5f4]/20" style="${ssrRenderStyle({ "opacity": "1", "transform": "none" })}"><dt class="mt-2 text-base text-[#f2f5f4]/80">Maintainer</dt><dd class="font-display text-3xl font-semibold text-[#f2f5f4] sm:text-4xl"> Tschucki </dd></div></a><div${ssrRenderAttrs(mergeProps({
    initial: { opacity: 0, y: 100 },
    enter: { opacity: 1, y: 0, scale: 1 },
    delay: 500,
    ...
    enter: { opacity: 1, y: 0, scale: 1 },
    delay: 900
  }, ssrGetDirectiveProps(_ctx, _directive_motion)))}><p class="text-base text-[#f2f5f4]/80">Weiter</p><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-8 w-8 text-[#f2f5f4]"><path stroke-linecap="round" stroke-linejoin="round" d="m9 12.75 3 3m0 0 3-3m-3 3v-7.5M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"></path></svg></div></div><div${ssrRenderAttrs(mergeProps({
