...
class AddOriginalContentLinkAction
{
    public static function make(): Action
    {
        ...
        ])->action(function (MyPoll $record, array $data) {
        ...
        })->visible(fn (MyPoll $record) => $record->isApproved() && ! $record->isInReview() && $record->hasEnded() && $record->original_content_link === null)->label('pr0-Post hinzufügen')->color('primary')->requiresConfirmation();
    }
}
