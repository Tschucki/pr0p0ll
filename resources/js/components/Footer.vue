...
<template>
  <footer class="mx-auto max-w-7xl px-6 lg:px-8 mt-24 w-full sm:pt-32 lg:pt-40" v-motion
    ...
    <div class="mx-auto max-w-2xl lg:max-w-none">
      <div style="opacity: 1; transform: none;">
        <div class="grid grid-cols-1 gap-x-8 gap-y-16 lg:grid-cols-2">
          <nav>
            <ul role="list" class="grid grid-cols-2 gap-8 sm:grid-cols-3">
              ...
              <li>
                <div class="font-display text-sm font-semibold tracking-wider text-[#f2f5f4]">Hilfe</div>
                <ul role="list" class="mt-4 text-sm text-[#f2f5f4]/80">
                  <li class="mt-4"><a class="transition hover:text-[#f2f5f4]" href="/">FAQ</a></li>
                  <li class="mt-4"><a class="transition hover:text-[#f2f5f4]" href="/">Diskussionen</a></li>
                  <li class="mt-4"><a class="transition hover:text-[#f2f5f4]" href="/">Auswertungen</a></li>
                </ul>
              </li>
              <li>
                <div class="font-display text-sm font-semibold tracking-wider text-[#f2f5f4]">Kontakt</div>
                <ul role="list" class="mt-4 text-sm text-[#f2f5f4]/80">
                  <li class="mt-4">
        ...
        <div
          ...
          <a aria-label="Home" href="/" class="text-[#f2f5f4] flex items-center gap-2 font-medium">
            <img alt="Pr0p0ll Logo" title="Pr0p0ll Logo" :src="pr0p0llImage" class="w-auto sm:h-8 h-4 aspect-square">
            Pr0p0ll
          </a>
          <p class="text-sm text-[#f2f5f4]">ԅ(≖‿≖ԅ)</p></div>
      </div>
    </div>
  </footer>
</template>
